...
// Added logical AND operator, to check the existence of futureId variable
...
correctDate = new Date(copied.date).setHours(0, 0)
...
const randomYear = new Date(randomHoliday.date).getFullYear() 
console.log(`${(randomDay.toString()).padStart(2, '0')}/${(randomMonth.toString()).padStart(2, '0')}/${randomYear.toString().padStart(2, '0')}`)
